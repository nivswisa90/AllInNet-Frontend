...
const StopTraining = () => {
  ...
  return (
    <div>
      <h1 style={{ fontWeight: 90, fontSize: 50, textAlign: "center", fontFamily: "'Encode sans Expanded', sans-serif" }}>
      ...
      <h3 style={{ fontWeight: 90, fontSize: 50, textAlign: "center", fontFamily: "'Encode sans Expanded', sans-serif" }}>
